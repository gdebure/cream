...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('users_profile', 'description', self.gf('django.db.models.fields.TextField')())
    
    
    def backwards(self, orm):
        
        # Changing field 'Profile.description'
        db.alter_column('users_profile', 'description', self.gf('django.db.models.fields.CharField')(max_length=255))
