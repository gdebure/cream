...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Authorization', fields ['employee', 'project']
        db.create_unique('users_authorization', ['employee_id', 'project_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Authorization', fields ['employee', 'project']
        db.delete_unique('users_authorization', ['employee_id', 'project_id'])
