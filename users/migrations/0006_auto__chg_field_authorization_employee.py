...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Authorization.employee'
        db.alter_column('users_authorization', 'employee_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Employee']))
    
    
    def backwards(self, orm):
        
        # Changing field 'Authorization.employee'
        db.alter_column('users_authorization', 'employee_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
