...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Skill.enabled'
        db.add_column('qualifications_skill', 'enabled', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)

        # Deleting field 'SkillCategory.enabled'
        db.delete_column('qualifications_skillcategory', 'enabled')
    
    
    def backwards(self, orm):
        
        # Deleting field 'Skill.enabled'
        db.delete_column('qualifications_skill', 'enabled')

        # Adding field 'SkillCategory.enabled'
        db.add_column('qualifications_skillcategory', 'enabled', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'qualifications.jobskill': {
            'Meta': {'unique_together': "(('job', 'skill'),)", 'object_name': 'JobSkill'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
