...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'EmployeeSkill', fields ['employee', 'skill']
        db.create_unique('qualifications_employeeskill', ['employee_id', 'skill_id'])
    
    
    def backwards(self, orm):
        
        # Removing unique constraint on 'EmployeeSkill', fields ['employee', 'skill']
        db.delete_unique('qualifications_employeeskill', ['employee_id', 'skill_id'])
