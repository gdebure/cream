...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EmployeeSkill'
        db.create_table('qualifications_employeeskill', (
        ...
        db.send_create_signal('qualifications', ['EmployeeSkill'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'EmployeeSkill'
        db.delete_table('qualifications_employeeskill')
    ...
    models = {
        ...
        'qualifications.employeeskill': {
            'Meta': {'object_name': 'EmployeeSkill'},
