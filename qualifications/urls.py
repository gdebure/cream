...
urlpatterns = patterns('',
    ##################################
    # Skills 
    (r'^skills/$', login_required()(ListView.as_view( queryset=Skill.objects.order_by('category','name'), context_object_name='skills_list', )), ),
    ...
    ##################################
    # Skill Categories 
    (r'^skill_categories/$', login_required()(ListView.as_view( queryset=SkillCategory.objects.order_by('name'), context_object_name='skill_categories_list', )), ),
    ...
    ##################################
    # Jobs
    (r'^jobs/$', login_required()(ListView.as_view( queryset=Job.objects.order_by('name'), context_object_name='jobs_list', )), ),
    ...
    ##################################
    # Employee Skills 
    (r'^employee_skills/$', login_required()(ListView.as_view( queryset=EmployeeSkill.objects.order_by('employee','skill'), context_object_name='employeeskills_list', )), ),
    ...
    ##################################
    # profiles 
    (r'^profiles/$', login_required()(ListView.as_view( queryset=Profile.objects.order_by('name'), context_object_name='profiles_list', )), ),
    ...
    ##################################
    # job profile Skills 
    (r'^job_skills/$', login_required()(ListView.as_view( queryset=JobProfileSkill.objects.order_by('job','skill'), context_object_name='jobprofileskills_list', )), ),
