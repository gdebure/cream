...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RequestorType'
        db.create_table('tasks_requestortype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('tasks', ['RequestorType'])
        ...
        db.create_table('tasks_task', (
            ...
            ('requestor_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tasks.RequestorType'])),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Employee'])),
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'RequestorType'
        db.delete_table('tasks_requestortype')
