...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('tasks_comment', 'task_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tasks.Task']))


    def backwards(self, orm):
        
        # Changing field 'Comment.task'
        db.alter_column('tasks_comment', 'task_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Employee']))
