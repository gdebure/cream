...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DeliverableVolume.unit_price'
        db.add_column('projects_deliverablevolume', 'unit_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DeliverableVolume.unit_price'
        db.delete_column('projects_deliverablevolume', 'unit_price')
