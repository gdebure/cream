...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('projects_task', (
            ...
            ('time_spent', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('criticity', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('reject_reason', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='creator', to=orm['users.Employee'])),
            ('deliverable', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Deliverable'])),
            ('requestor', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('close_date', self.gf('django.db.models.fields.DateField')(null=True)),
        ...
        # Adding M2M table for field owner on 'Task'
        db.create_table('projects_task_owner', (
        ...
        db.create_unique('projects_task_owner', ['task_id', 'employee_id'])

        # Adding M2M table for field subject on 'Task'
        db.create_table('projects_task_subject', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('task', models.ForeignKey(orm['projects.task'], null=False)),
            ('subject', models.ForeignKey(orm['projects.subject'], null=False))
        ))
        db.create_unique('projects_task_subject', ['task_id', 'subject_id'])

        # Adding model 'Subject'
        db.create_table('projects_subject', (
            ('subject_family', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.SubjectFamily'])),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.create_table('projects_subject_project', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('subject', models.ForeignKey(orm['projects.subject'], null=False)),
            ('project', models.ForeignKey(orm['projects.project'], null=False))
        ))
        db.create_unique('projects_subject_project', ['subject_id', 'project_id'])

        # Adding model 'SubjectFamily'
        db.create_table('projects_subjectfamily', (
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal('projects', ['SubjectFamily'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field owner on 'Task'
        db.delete_table('projects_task_owner')

        # Removing M2M table for field subject on 'Task'
        db.delete_table('projects_task_subject')

        # Deleting model 'Subject'
        db.delete_table('projects_subject')

        # Removing M2M table for field project on 'Subject'
        db.delete_table('projects_subject_project')

        # Deleting model 'SubjectFamily'
        db.delete_table('projects_subjectfamily')
