...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.project_leader'
        db.alter_column('projects_project', 'project_leader_id', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, to=orm['users.Employee']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Project.project_leader'
        db.alter_column('projects_project', 'project_leader_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Employee']))
