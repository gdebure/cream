...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Deliverable.approved_by_service_owner'
        db.alter_column('projects_deliverable', 'approved_by_service_owner', self.gf('django.db.models.fields.BooleanField')(blank=True))
    ...
    models = {
        ...
        'projects.deliverable': {
            ...
            'approved_by_service_owner': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
