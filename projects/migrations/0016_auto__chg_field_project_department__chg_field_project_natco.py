...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.department'
        db.alter_column('projects_project', 'department', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True))

        # Changing field 'Project.natco'
        db.alter_column('projects_project', 'natco', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Project.department'
        db.alter_column('projects_project', 'department', self.gf('django.db.models.fields.CharField')(max_length=2))

        # Changing field 'Project.natco'
        db.alter_column('projects_project', 'natco', self.gf('django.db.models.fields.CharField')(max_length=2))
