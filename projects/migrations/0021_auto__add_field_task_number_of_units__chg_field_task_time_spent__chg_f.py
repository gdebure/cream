...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Task.number_of_units'
        db.add_column('projects_task', 'number_of_units', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Changing field 'Task.time_spent'
        db.alter_column('projects_task', 'time_spent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2, blank=True))

        # Changing field 'Task.close_date'
        db.alter_column('projects_task', 'close_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True))

        # Changing field 'Task.answer'
        db.alter_column('projects_task', 'answer', self.gf('django.db.models.fields.TextField')(null=True, blank=True))

        # Changing field 'Task.reject_reason'
        db.alter_column('projects_task', 'reject_reason', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True))

        # Changing field 'DeliverableVolume.unit_price'
        db.alter_column('projects_deliverablevolume', 'unit_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Task.number_of_units'
        db.delete_column('projects_task', 'number_of_units')

        # Changing field 'Task.time_spent'
        db.alter_column('projects_task', 'time_spent', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

        # Changing field 'Task.close_date'
        db.alter_column('projects_task', 'close_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Task.answer'
        db.alter_column('projects_task', 'answer', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Task.reject_reason'
        db.alter_column('projects_task', 'reject_reason', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'DeliverableVolume.unit_price'
        db.alter_column('projects_deliverablevolume', 'unit_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2, blank=True))
    ...
    models = {
        ...
        'projects.deliverablevolume': {
            ...
            'unit_price': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'})
        },
        'projects.profile': {
        ...
        'projects.task': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'number_of_units': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'open_date': ('django.db.models.fields.DateField', [], {}),
            'owner': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'owner'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['users.Employee']"}),
            'reject_reason': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            ...
            'time_spent': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '5', 'decimal_places': '2', 'blank': 'True'})
        },
        'services.domain': {
