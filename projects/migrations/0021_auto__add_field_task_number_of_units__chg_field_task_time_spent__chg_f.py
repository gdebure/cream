...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('projects_task', 'time_spent', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2))

        # Changing field 'Task.reject_reason'
        db.alter_column('projects_task', 'reject_reason', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Task.time_spent'
        db.alter_column('projects_task', 'time_spent', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=5, decimal_places=2))

        # Changing field 'Task.reject_reason'
        db.alter_column('projects_task', 'reject_reason', self.gf('django.db.models.fields.CharField')(default='', max_length=64))
