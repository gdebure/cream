...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Deliverable.unit_price'
        db.delete_column('projects_deliverable', 'unit_price')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Deliverable.unit_price'
        db.add_column('projects_deliverable', 'unit_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True), keep_default=False)
