...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Deliverable.service'
        db.alter_column('projects_deliverable', 'service_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['services.Service'], null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Deliverable.service'
        db.alter_column('projects_deliverable', 'service_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['services.Service']))
