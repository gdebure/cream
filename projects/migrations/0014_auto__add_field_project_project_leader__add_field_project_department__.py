...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.natco'
        db.add_column('projects_project', 'natco', self.gf('django.db.models.fields.CharField')(default='', max_length=2), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Project.project_leader'
        db.delete_column('projects_project', 'project_leader_id')

        # Deleting field 'Project.department'
        db.delete_column('projects_project', 'department')

        # Deleting field 'Project.natco'
        db.delete_column('projects_project', 'natco')
    ...
    models = {
        ...
        'projects.project': {
            ...
            'department': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'natco': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'number': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '32'}),
            'project_leader': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.Employee']"}),
