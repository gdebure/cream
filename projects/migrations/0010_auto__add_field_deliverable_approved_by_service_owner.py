...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Deliverable.approved_by_service_owner'
        db.add_column('projects_deliverable', 'approved_by_service_owner', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Deliverable.approved_by_service_owner'
        db.delete_column('projects_deliverable', 'approved_by_service_owner')
    ...
    models = {
        ...
        'projects.deliverable': {
            ...
            'approved_by_service_owner': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
        ...
        'projects.project': {
            ...
            'wiki_link': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'})
        },
        'projects.subject': {
