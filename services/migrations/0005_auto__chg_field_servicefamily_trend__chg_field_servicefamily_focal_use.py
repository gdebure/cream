...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('services_servicefamily', 'focal_user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Employee'], null=True))


    def backwards(self, orm):
        
        # Changing field 'ServiceFamily.trend'
        db.alter_column('services_servicefamily', 'trend', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'ServiceFamily.focal_user'
        db.alter_column('services_servicefamily', 'focal_user_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['users.Employee']))
    ...
    models = {
        ...
        'services.servicefamily': {
            ...
            'focal_user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.Employee']", 'null': 'True', 'blank': 'True'}),
