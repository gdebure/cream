...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ServiceFamily.focal_point'
        db.alter_column('services_servicefamily', 'focal_point_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Employee'], null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'ServiceFamily.focal_point'
        db.alter_column('services_servicefamily', 'focal_point_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Employee'], null=True))
